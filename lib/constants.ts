...
export const SKILLS = {
  ...
  "Containers & Orchestration": ["Docker", "Kubernetes (EKS)", "Amazon ECS"],
  "CI/CD & Automation": ["Jenkins", "GitHub Actions", "AWS CodePipeline", "CodeBuild", "CodeDeploy"],
  "Scripting & Languages": ["Python", "Bash", "YAML", "Kotlin"],
  "Monitoring & Observability": ["CloudWatch", "Prometheus", "Grafana"],
  "Databases": ["RDS (PostgreSQL/MySQL)", "DynamoDB", "ElastiCache"],
  "Networking & Servers": ["VPC", "Route 53", "Nginx", "Apache", "ALB/NLB"],
};
