-- ============================================================================
-- Update site_content row for section='projects' with all 7 showcase entries.
-- DevOps Academy is the flagship lead (first in the array).
  ...
  "projects": [
    {
      ...
      "featured": true,
      "standout": "Continuity engine — AI teacher resumes exactly where the user left off. Plus real terminal-lab grading via devops-lab CLI, Obsidian notes sync, and 3-tier Razorpay monetization from day one.",
      "category": "Web",
      "highlights": [
    ...
    },
    {
      ...
      "highlights": [
        ...
        "Custom AI toolbar with 7 presets (AI tool: Fix, Translate, 5 user-defined)",
    ...
    },
    {
      ...
      "highlights": [
        ...
        "Togglable home-screen widget via AppWidgetProvider",
    ...
    },
    {
      ...
      "featured": false,
      "standout": "Self-documenting — /devops shows the live CI/CD pipeline, /blog has Reddit-style threaded comments over Supabase Realtime, and /projects lists itself as one of the projects.",
      "category": "Web",
      "highlights": [
