  ...
  return (
    <div className="mx-auto flex min-h-[70vh] max-w-2xl flex-col items-center justify-center px-6 py-20 text-center">
      ...
      <div className="mt-8 flex gap-3">
        ...
        <Link href="/dashboard" className="btn btn-ghost text-[0.7rem]">
          Back to dashboard
        </Link>
      </div>
    </div>
